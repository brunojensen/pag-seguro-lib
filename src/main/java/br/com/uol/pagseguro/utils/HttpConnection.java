...
public class HttpConnection {
     ...
     */
    @Deprecated
    public HttpURLConnection get(final String urlPS, final String timeout, final String charset)
        throws PagSeguroServiceException {
     ...
     * @throws PagSeguroServiceException
     */
    public HttpURLConnection get(final String urlPS,
                                 final String timeout,
                                 final String charset,
                                 final String acceptHeader) throws PagSeguroServiceException {
     ...
     * @throws PagSeguroServiceException
     */
    private HttpURLConnection getConnection(final String urlPS,
                                            final String timeout,
                                            final String charset,
                                            final String method,
                                            final String acceptHeader) throws PagSeguroServiceException {
        ...
        try {
            ...
            connection.setRequestProperty("language-engine-description", "java:"
                + PagSeguroSystem.getLanguageEnginedescription());

            final String moduleVersion = PagSeguroConfig.getModuleVersion();
            if (moduleVersion != null) {
                connection.setRequestProperty("module-description", moduleVersion);
            }

            final String cmsVersion = PagSeguroConfig.getCmsVersion();
            if (cmsVersion != null) {
     ...
     */
    @Deprecated
    public HttpURLConnection httpRequestMethod(final String urlPS,
                                               final String timeout,
                                               final String charset,
                                               final String method) throws PagSeguroServiceException {
     ...
     */
    @Deprecated
    public HttpURLConnection post(final String urlPS,
                                  final Map<Object, Object> data,
                                  final String timeout,
                                  final String charset) throws PagSeguroServiceException {
    ...
    public HttpURLConnection post(final String urlPS,
        ...
        final HttpURLConnection connection = getConnection(urlPS, timeout, charset, "POST", acceptHeader);

        try {
            // Send POST data
            final OutputStream out = connection.getOutputStream();
            final Writer write = new OutputStreamWriter(out, charset);
