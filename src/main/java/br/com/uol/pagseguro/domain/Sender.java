...
public class Sender {
     ...
     * @param email
     */
    public Sender(final String name, final String email) {
     ...
     * @param phone
     */
    public Sender(final String name, final String email, final Phone phone) {
        this.name = PagSeguroUtil.removeExtraSpaces(name);
        this.email = email;
        this.phone = phone;
    }
     ...
     * @param document
     */
    public Sender(final String name, final String email, final Phone phone, final SenderDocument document) {
        this.name = PagSeguroUtil.removeExtraSpaces(name);
        this.email = email;
        this.phone = phone;
     ...
     * @param bornDate
     */
    public Sender(final String name, final String email, final Phone phone, final String bornDate) {
        this.name = PagSeguroUtil.removeExtraSpaces(name);
        this.email = email;
        this.phone = phone;
        this.bornDate = bornDate;
     ...
     * @param value
     */
    public void addDocument(final DocumentType type, final String value) {
     ...
     * @param document
     */
    public void addDocument(final SenderDocument document) {
     ...
     * @param documents
     */
    public void setDocuments(final List<SenderDocument> documents) {
