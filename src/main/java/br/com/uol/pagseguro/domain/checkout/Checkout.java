...
public class Checkout {
     ...
     * 
     * Optional. This value can be used to add an extra charge to the
     * transaction or provide a discount in the case ExtraAmount is a negative
     * value.
     */
     ...
     * 
     * Optional. After this checkout request is submitted, the payment code
     * returned will remain valid for the period specified here.
     */
    private BigInteger maxAge;

    /**
     * How many times the payment redirect url returned by the payment web
     * service can be accessed.
     * 
     * Optional. After this checkout request is submitted, the payment redirect
     * url returned by the checkout web service will remain valid for the number
     ...
     * 
     * Optional. A new notification will be send to this url if any change
     * happens in the transaction status. You can use that for update the
     * related order.
     */
    ...
    public void addItem(String id,
        ...
        this.getItems()
            .add(new Item(id, description, quantity, amount, weight, shippingCost));
    }
     ...
     * @param complement
     */
    public void setShipping(ShippingType type,
                            String country,
                            String state,
                            String city,
                            String district,
     ...
     * @param complement
     */
    public void setShippingAddress(String country,
                                   String state,
                                   String city,
                                   String district,
                                   String postalCode,
    ...
    public void addMetaDataItem(MetaDataItemKey key, String value, Integer group) {
        this.getMetaData()
            .addItem(new MetaDataItem(key, value, group));
    }
    ...
    public void addMetaDataItem(MetaDataItemKey key, String value) {
        this.getMetaData()
            .addItem(new MetaDataItem(key, value));
    }
    ...
    public void addParameter(String name, String value) {
        this.getParameter()
            .addItem(new ParameterItem(name, value));
    }
    ...
    public void addIndexedParameter(String name, String value, Integer index) {
        this.getParameter()
            .addItem(new ParameterItem(name, value, index));
    }
