...
public class Error {
     ...
     * arguments
     *
     * @param code the ws error code, i.e. 13001
     * @param message the ws error description, i.e. invalid notification code
     *            value: {0}
     */
    ...
    /**
     * @param code the ws error code to set, i.e. 13001
     */
    ...
    /**
     * @param message the ws error description to set, i.e. invalid notification
     *            code value: {0}
     */
