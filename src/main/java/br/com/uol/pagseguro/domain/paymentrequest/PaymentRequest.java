...
public class PaymentRequest {
    ...
    /**
     * Initializes a new instance of the PaymentRequest class with the specified
     * arguments
     * 
     * @param name
     * @param reference
    ...
    public PaymentRequest(String name,
                          ...
                          PaymentRequestShipping shipping,
                          String description,
                          Integer expiration,
                          Integer due) {
        super();
    ...
    public void addItem(String id, String description, BigDecimal amount, Integer quantity) {
        this.getItems()
            .add(new PaymentRequestItem(id, description, amount, quantity));
    }
