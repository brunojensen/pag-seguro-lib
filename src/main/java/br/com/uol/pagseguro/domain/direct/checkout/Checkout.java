...
public abstract class Checkout {
    ...
    /**
     * @param notificationUrl the notification URL to set
     */
    ...
    /**
     * @param senderHash the sender hash to set
     */
    ...
    public Map<Object, Object> getMap() {
        ...
        if (shipping != null) {
            ...
            if (shipping.getType() != null) {
                data.put("shippingType", shipping.getType()
                                                 .getValue());
            }
         ...
         * @see Parameter
         */
        if (getParameter() != null && getParameter().getItems() != null && !getParameter().getItems()
                                                                                          .isEmpty()) {
