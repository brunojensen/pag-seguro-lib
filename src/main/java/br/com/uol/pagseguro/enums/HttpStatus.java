...
/**
 * Enum constants that represents the HTTP Status that can be returned on
 * payment requests
 */
public enum HttpStatus {
     ...
     *
     * @param code - the http code of the enum constant to be returned
     * @return the enum constant from a given value
     */
    public static HttpStatus fromCode(final Integer code) {
     ...
     */
    HttpStatus(final Integer code, final String description) {
        this.code = code;
    ...
    /**
     * @param code - new http code for this enum constant
     */
    ...
    /**
     * @param description - new http description for this enum constant
     */
