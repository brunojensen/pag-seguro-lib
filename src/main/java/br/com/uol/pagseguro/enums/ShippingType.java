...
public enum ShippingType {
     ...
     */
    public static ShippingType fromValue(final Integer value) {

        for (final ShippingType shippingType : ShippingType.values()) {
     ...
     * arguments
     *
     * @param description - the type of the enum constant
     * @param value - the value of the enum constant
     */
    ShippingType(final String description, final Integer value) {
