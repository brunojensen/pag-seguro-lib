...
public enum PaymentMethodCode {
     ...
     * <code>UNKNOWN_CODE</code>
     *
     * @param value - the value of the enum constant to be returned
     * @return the enum constant from a given value
     */
    public static PaymentMethodCode fromValue(final Integer value) {

        for (final PaymentMethodCode paymentMethodCode : PaymentMethodCode.values()) {
     ...
     */
    PaymentMethodCode(final PaymentMethodType type, final String description, final Integer value) {
        this.type = type;
     ...
     */
    public void setDescription(final String type) {
        description = type;
    }
     ...
     */
    public void setType(final PaymentMethodType type) {
        this.type = type;
    }
