...
public class AuthorizationSearchService {
     ...
     * @throws PagSeguroServiceException
     */
    private static String buildSearchUrlByDate(ConnectionData connectionData,
                                               String initialDate,
                                               String finalDate,
                                               Integer pageNumber,
                                               Integer resultsPerPage) throws PagSeguroServiceException {
     ...
     * @throws Exception
     */
    public static List<Authorization> searchByDate(Credentials credentials,
                                                   Date initialDate,
                                                   Date finalDate,
                                                   int pageNumber,
     ...
     * @throws Exception
     */
    public static HttpURLConnection searchAuthorization(Credentials credentials,
                                                        String authorizationSearchURL,
                                                        String serviceTimeout,
                                                        String charset,
                                                        String logInfo) throws PagSeguroServiceException {
