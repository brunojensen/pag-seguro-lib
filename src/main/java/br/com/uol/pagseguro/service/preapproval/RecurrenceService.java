...
public class RecurrenceService {
    ...
    public static RecurrenceTransaction findByCode(Credentials credentials, String recurrenceCode)
        ...
        try {
            ...
            if (HttpURLConnection.HTTP_OK == httpStatusCode.getCode()
                ...
                RecurrenceTransaction recurrenceTransaction = RecurrenceParser.readRecurrence(response.getInputStream());
    ...
    public static RecurrenceCancelTransaction cancelRecurrenceByCode(Credentials credentials, String recurrenceCode)
        ...
        HttpURLConnection response = connection.httpRequestMethod(buildRecurrenceCancelByCodeUrl(connectionData,
                                                                                                 recurrenceCode),
                                                                  connectionData.getServiceTimeout(),
                                                                  connectionData.getCharset(), "POST",
                                                                  PagSeguroSystem.getAcceptHeaderXML());
