...
public class PaymentParser {
     ...
     * @return mixed
     */
    public static Map<Object, Object> getData(final Checkout checkout) {
     ...
     */
    @Deprecated
    public static Map<Object, Object> getData(final PaymentRequest payment) {
        ...
        if (payment.getSender() != null) {
            ...
            if (payment.getSender()
                       .getName() != null) {
                data.put("senderName", payment.getSender()
                                              .getName());
            }

            if (payment.getSender()
                       .getEmail() != null) {
                data.put("senderEmail", payment.getSender()
                                               .getEmail());
            }

            if (payment.getSender()
                       .getBornDate() != null) {
                data.put("senderBornDate", payment.getSender()
                                                  .getBornDate());
            }
            ...
            if (payment.getSender()
                ...
                if (payment.getSender()
                           .getPhone()
                           .getAreaCode() != null) {
                    data.put("senderAreaCode", payment.getSender()
                                                      .getPhone()
                                                      .getAreaCode());
                }
                if (payment.getSender()
                           .getPhone()
                           .getNumber() != null) {
                    data.put("senderPhone", payment.getSender()
                                                   .getPhone()
                                                   .getNumber());
                }
            }
            ...
            if (payment.getSender()
                ...
                final List<SenderDocument> documents = payment.getSender()
                                                              .getDocuments();

                if (!documents.isEmpty()) {
                    for (final SenderDocument document : documents) {
        ...
        if (payment.getItems() != null && payment.getItems()
                                                 .size() > 0) {

            Integer count = 0;

            for (final Item item : payment.getItems()) {
                count++;
        ...
        if (payment.getShipping() != null) {
            ...
            if (payment.getShipping()
                       .getType() != null && (payment.getShipping()
                                                     .getType()
                                                     .getValue() != null)) {
                data.put("shippingType", payment.getShipping()
                                                .getType()
                                                .getValue());
            }
            if (payment.getShipping()
                       .getCost() != null) {
                data.put("shippingCost", payment.getShipping()
                                                .getCost());
            }
            /**
             * ADDRESS
            ...
            if (payment.getShipping()
                ...
                if (payment.getShipping()
                           .getAddress()
                           .getStreet() != null) {
                    data.put("shippingAddressStreet", payment.getShipping()
                                                             .getAddress()
                                                             .getStreet());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getNumber() != null) {
                    data.put("shippingAddressNumber", payment.getShipping()
                                                             .getAddress()
                                                             .getNumber());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getComplement() != null) {
                    data.put("shippingAddressComplement", payment.getShipping()
                                                                 .getAddress()
                                                                 .getComplement());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getCity() != null) {
                    data.put("shippingAddressCity", payment.getShipping()
                                                           .getAddress()
                                                           .getCity());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getState() != null) {
                    data.put("shippingAddressState", payment.getShipping()
                                                            .getAddress()
                                                            .getState());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getDistrict() != null) {
                    data.put("shippingAddressDistrict", payment.getShipping()
                                                               .getAddress()
                                                               .getDistrict());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getPostalCode() != null) {
                    data.put("shippingAddressPostalCode", payment.getShipping()
                                                                 .getAddress()
                                                                 .getPostalCode());
                }
                if (payment.getShipping()
                           .getAddress()
                           .getCountry() != null) {
                    data.put("shippingAddressCountry", payment.getShipping()
                                                              .getAddress()
                                                              .getCountry());
                }
            }
         ...
         * @see MetaData
         */
        if (payment.getMetaData() != null && payment.getMetaData()
                                                    .getItem() != null && !payment.getMetaData()
                                                                                  .getItem()
                                                                                  .isEmpty()) {

            Integer count = 0;

            for (final MetaDataItem meta : payment.getMetaData()
                                                  .getItem()) {
         ...
         * @see Parameter
         */
        if (payment.getParameter() != null && payment.getParameter()
                                                     .getItems() != null && !payment.getParameter()
                                                                                    .getItems()
                                                                                    .isEmpty()) {

            for (final ParameterItem param : payment.getParameter()
                                                    .getItems()) {

                if ((param.getName() != null && !"".equals(param.getName()))
                    && (param.getValue() != null && !"".equals(param.getValue()))) {
                    if (param.getIndex() != null) {
                        data.put(param.getName() + "" + param.getIndex()
